...
namespace PublicLecture.Controllers
{
    ...
    public class UserController : ControllerBase
    {
        ...
        public async Task<IActionResult> DeleteUser(string userid)
        {
            ...
            {
                return Unauthorized(new { Message = "Nincs jogosultsága törölni ezt a felhasználót" });
            }
        ...
        public async Task<IActionResult> Register(UserInputDto dto)
        {
            ...
            {
                return BadRequest(new { Message = "A megadott felhasználónév már foglalt." });
            }
        ...
        private JwtSecurityToken GenerateAccessToken(IEnumerable<Claim>? claims, int expiryInMinutes)
        {
            ...
            return new JwtSecurityToken(
                  issuer: "publiclecture.com",
                  audience: "publiclecture.com",
